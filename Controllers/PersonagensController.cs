...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://brenolisboa2004.somee.com/RpgApi/Personagens/";    
        ...
        public async Task<IActionResult> CreateAsync(PersonagemViewModel p)
        {
            try
            {
                HttpClient httpClient = new HttpClient();
                string token = HttpContext.Session.GetString("SessionTokenUsuario");
                httpClient.DefaultRequestHeaders.Authorization =  new AuthenticationHeaderValue("Bearrer, token");
